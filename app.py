...
def pdf_to_img(pdf_file,output_path):
    # pdf_file = convert_pdf(pdf_file,output_path)
    # return pdf_file
    return pdf2image.convert_from_path(pdf_file,output_folder=output_path) 
...
def print_pages(pdf_file,output_path):
    images = pdf_to_img(pdf_file,output_path)
...
def get_details():
  if request.method == 'POST':
        ...
        result= print_pages(file_path,uploads_dir)      
        return result    
